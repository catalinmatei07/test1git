...
$result = mysqli_query($mysqli, "UPDATE elevi SET nume='$nume',prenume='$prenume',adresa='$adresa',emailul='$emailul',data_nasterii='$data_nasterii',sex='$sex',media_bac='$media_bac' WHERE id=$id");
